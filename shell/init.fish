# Generated by bios init fish. Do not paste this into your rc file.
# Put this one line at the end of ~/.config/fish/config.fish instead, so it stays current:
...
if status is-interactive; and command -v bios >/dev/null 2>&1
    ...
    set -gx SPARKLEBIOS_HOOK {{HOOK_HASH}}
    set -gx SPARKLEBIOS_HOOK_SHELL {{HOOK_SHELL}}
